...
public class ScanResult extends AppCompatActivity implements MokoScanDeviceCallback {
...
//        EventBus.getDefault().register(this);
    ...
    public void onScanDevice(DeviceInfo device) {
        ...
        if (Mac_filter == null) {
            ...
            if (device.mac.equals(Mac_filter)) {
                double dist = getDistance(device.rssi, -80);
                //Toast.makeText(this, "RssI : " +device.rssi, Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "RssI : " + device.rssi + "Mac is : " + device.mac + " Distance is : " + dist, Toast.LENGTH_SHORT).show();
    ...
    public class CunstomHandler extends BaseMessageHandler<ScanResult> {

        public CunstomHandler(ScanResult activity) {
            super(activity);
        }

        @Override
        protected void handleMessage(ScanResult home, Message msg) {
